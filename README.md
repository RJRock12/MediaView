...
v 9.6.4: (mostly tested and confirmed mostly stable, possible bugs) Added button to pop out the visuals in a picture in picture format. Can be used as a miniplayer. <br>
V 9.6.2: (fully tested and confirmed stable) Improved Visuals Section, made more user friendly.<br>
